...
class SelloP extends React.Component {
	...
	purchaseOB2 = async (id, contractManager, price) => {
		...
		await oxygen.methods.purchaseOB(id, contractManager).send({ gas:  20000000, from: accounts[0],  value: price, });
		...
		return (
			<div>
				...
				<button class="button button1" onClick={this.ViewFields}>
					Wyświetl wszystkie aktualne obligacje, które można dzierżawić
				</button>
